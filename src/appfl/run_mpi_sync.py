...
def run_server(
    ...
    for iter in range(cfg.num_epochs):
        ...
        print(f"======Server global_update_time: {time.time() - global_update_start}, start at {global_update_start}, end at {time.time()}======", flush=True)
    ...
    global_broadcast_end = time.time()
    print(f"======Server global_broadcast_time for ending: {global_broadcast_end - global_broadcast_start}, start at {global_broadcast_start}, end at {global_broadcast_end}======", flush=True)
